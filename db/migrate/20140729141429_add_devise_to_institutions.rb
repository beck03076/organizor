class AddDeviseToInstitutions < ActiveRecord::Migration
  def self.up
    change_table(:institutions) do |t|
      ...
      # t.string :email,              null: false, default: "" # deleted by senthil since there is already an email field
    ...
    #add_index :institutions, :email,                unique: true # by senthil for the same reasons
