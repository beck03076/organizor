...
class PersonTypesControllerTest < ActionController::TestCase
  ...
  test "should create person_type" do
    assert_difference('PersonType.count') do
      post :create, person_type: { created_by: @person_type.created_by, desc: @person_type.desc, name: @person_type.name, updated_by: @person_type.updated_by }
    end
  ...
  test "should update person_type" do
    put :update, id: @person_type, person_type: { created_by: @person_type.created_by, desc: @person_type.desc, name: @person_type.name, updated_by: @person_type.updated_by }
    assert_redirected_to person_type_path(assigns(:person_type))
  end
