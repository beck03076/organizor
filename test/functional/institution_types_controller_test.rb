...
class InstitutionTypesControllerTest < ActionController::TestCase
  ...
  test "should create institution_type" do
    assert_difference('InstitutionType.count') do
      post :create, institution_type: { created_by: @institution_type.created_by, desc: @institution_type.desc, name: @institution_type.name, updated_by: @institution_type.updated_by }
    end
  ...
  test "should update institution_type" do
    put :update, id: @institution_type, institution_type: { created_by: @institution_type.created_by, desc: @institution_type.desc, name: @institution_type.name, updated_by: @institution_type.updated_by }
    assert_redirected_to institution_type_path(assigns(:institution_type))
  end
