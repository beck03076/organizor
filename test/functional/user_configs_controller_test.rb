...
class UserConfigsControllerTest < ActionController::TestCase
  ...
  test "should create user_config" do
    assert_difference('UserConfig.count') do
      post :create, user_config: { def_follow_up_days: @user_config.def_follow_up_days, user_id: @user_config.user_id }
    end
  ...
  test "should update user_config" do
    put :update, id: @user_config, user_config: { def_follow_up_days: @user_config.def_follow_up_days, user_id: @user_config.user_id }
    assert_redirected_to user_config_path(assigns(:user_config))
  end
