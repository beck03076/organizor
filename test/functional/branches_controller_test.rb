...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { created_by: @branch.created_by, desc: @branch.desc, name: @branch.name, updated_by: @branch.updated_by }
    end
  ...
  test "should update branch" do
    put :update, id: @branch, branch: { created_by: @branch.created_by, desc: @branch.desc, name: @branch.name, updated_by: @branch.updated_by }
    assert_redirected_to branch_path(assigns(:branch))
  end
