...
describe FeesController do
  ...
  let(:valid_attributes) { { "tuition_fee_cents" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved fee as @fee" do
        ...
        post :create, {:fee => { "tuition_fee_cents" => "invalid value" }}, valid_session
        assigns(:fee).should be_a_new(Fee)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested fee" do
        ...
        Fee.any_instance.should_receive(:update_attributes).with({ "tuition_fee_cents" => "1" })
        put :update, {:id => fee.to_param, :fee => { "tuition_fee_cents" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the fee as @fee" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Fee.any_instance.stub(:save).and_return(false)
        put :update, {:id => fee.to_param, :fee => { "tuition_fee_cents" => "invalid value" }}, valid_session
        assigns(:fee).should eq(fee)
      end
