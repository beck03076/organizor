...
describe "processing_fee_types/edit" do
  before(:each) do
  ...
  it "renders the edit processing_fee_type form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", processing_fee_type_path(@processing_fee_type), "post" do
